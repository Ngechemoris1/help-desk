...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO  tblroutes(routeName,CreationDate) VALUES(:route,:creationDate)";
										...
										<div class="panel-body">
											<form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control" name="route" id="brand" required>
													</div><br>
													<br>
													<label class="col-sm-4 control-label">Creation Date</label>
													<div class="col-sm-8">
														<input type="date" class="form-control" name="creationDate" id="brand" required>
													</div>
